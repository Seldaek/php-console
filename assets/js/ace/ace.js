(function () {
    ...
    b.addListener = function (a, b, c) {
        ...
        b.addListener(a, "mousedown", l), e.isOldIE && b.addListener(a, "dblclick", l)
    ...
    (function () {
        d.implement(this, n), this.setKeyboardHandler = function (a) {
            ...
            var a = this.getCursorPosition(),
                b = this.session.findMatchingBracket(a);
    ...
    var d = a("../lib/event"),
        ...
        g = function (a, b) {
            ...
            d.addCommandKeyListener(c, b.onCommandKey.bind(b)), d.addListener(c, "input", e.isIE ? o : n), d.addListener(c, "paste", function (a) {
            ...
            }), d.addListener(c, "cut", t)) : e.isOpera ? d.addListener(a, "keydown", function (a) {
                ...
                k || (k = c.style.cssText), c.style.cssText = "position:fixed; z-index:100000;left:" + (a.clientX - 2) + "px; top:" + (a.clientY - 2) + "px;", b.selection.isEmpty() && (c.value = "");
                if (a.type != "mousedown") return;
                b.renderer.$keepTextAreaAtCursor && (b.renderer.$keepTextAreaAtCursor = null), d.capture(b.container, function (a) {
                    c.style.left = a.clientX - 2 + "px", c.style.top = a.clientY - 2 + "px"
                }, v)
            }, this.onContextMenuClose = v, e.isGecko || d.addListener(c, "contextmenu", function (a) {
                b.textInput.onContextMenu(a), v()
            })
        };
    b.TextInput = g
}), define("ace/mouse/mouse_handler", ["require", "exports", "module", "ace/lib/event", "ace/mouse/default_handlers", "ace/mouse/default_gutter_handler", "ace/mouse/mouse_event", "ace/mouse/dragdrop"], function (a, b, c) {
    var d = a("../lib/event"),
        e = a("./default_handlers").DefaultHandlers,
        f = a("./default_gutter_handler").GutterHandler,
        g = a("./mouse_event").MouseEvent,
        h = a("./dragdrop").DragdropHandler,
        i = function (a) {
            this.editor = a, new e(this), new f(this), new h(this), d.addListener(a.container, "mousedown", function (b) {
        ...
        this.$scrollSpeed = 1, this.setScrollSpeed = function (a) {
            ...
            var e = this,
                f = function (a) {
                    ...
                    clearInterval(i), e[e.state + "End"] && e[e.state + "End"](a), e.$clickSelection = null, c.$keepTextAreaAtCursor == null && (c.$keepTextAreaAtCursor = !0, c.$moveTextAreaToCursor())
                }, h = function () {
                    e[e.state] && e[e.state]()
                };
    ...
    }).call(i.prototype), b.MouseHandler = i
}), define("ace/mouse/default_handlers", ["require", "exports", "module", "ace/lib/dom", "ace/lib/useragent"], function (a, b, c) {
    function g(a) {
    ...
    (function () {
        this.onMouseDown = function (a) {
            ...
            var d = this.editor,
                ...
                f = a.getButton();
            if (f !== 0) {
                var g = d.getSelectionRange(),
                    h = g.isEmpty();
                return h && (d.moveCursorToPosition(c), d.selection.clearSelection()), d.textInput.onContextMenu(a.domEvent), a.stop()
            }
            if (b && !d.isFocused()) {
                d.focus();
                if (this.$focusWaitTimout && !this.$clickSelection) return this.setState("focusWait"), this.captureMouse(a), a.preventDefault()
            }
            if (!b || this.$clickSelection || a.getShiftKey()) this.startSelect(c);
            else if (b) {
                var i = a.domEvent;
                i.ctrlKey || i.altKey ? this.startDrag() : (this.mousedownEvent.time = (new Date).getTime(), this.setState("dragWait"))
            }
            return this.captureMouse(a), a.preventDefault()
...
}), define("ace/mouse/default_gutter_handler", ["require", "exports", "module", "ace/lib/dom"], function (a, b, c) {
    function e(a) {
        var b = a.editor;
        a.editor.setDefaultHandler("guttermousedown", function (c) {
            var e = c.domEvent.target;
            if (e.className.indexOf("ace_gutter-cell") == -1) return;
            if (!b.isFocused()) return;
            var f = parseInt(d.computedStyle(e).paddingLeft);
            if (c.x < f + e.getBoundingClientRect().left + 1) return;
            var g = c.getDocumentPosition().row,
                h = b.session.selection;
            return c.getShiftKey() ? h.selectTo(g, 0) : (h.moveCursorTo(g, 0), h.selectLine(), a.$clickSelection = h.getRange()), a.captureMouse(c, "selectByLines"), c.preventDefault()
        })
    }
    var d = a("../lib/dom");
    b.GutterHandler = e
...
}), define("ace/mouse/dragdrop", ["require", "exports", "module", "ace/lib/event"], function (a, b, c) {
    var d = a("../lib/event"),
        e = function (a) {
            var b = a.editor,
                c, e, f, g, h, i, j, k = 0,
            ...
            d.addListener(l, "dragenter", function (a) {
                console.log(a.type, k, a.target), k++;
                if (!c) {
...
}), define("ace/edit_session", ["require", "exports", "module", "ace/config", "ace/lib/oop", "ace/lib/lang", "ace/lib/net", "ace/lib/event_emitter", "ace/selection", "ace/mode/text", "ace/range", "ace/document", "ace/background_tokenizer", "ace/search_highlight", "ace/edit_session/folding", "ace/edit_session/bracket_match"], function (a, b, c) {
    var d = a("./config"),
        e = a("./lib/oop"),
        f = a("./lib/lang"),
        g = a("./lib/net"),
        ...
        o = function (a, b) {
            this.$modified = !0, this.$breakpoints = [], this.$frontMarkers = {}, this.$backMarkers = {}, this.$markerId = 1, this.$resetRowCache(0), this.$wrapData = [], this.$foldData = [], this.$rowLengthCache = [], this.$undoSelect = !0, this.$foldData.toString = function () {
                var a = "";
    ...
    (function () {
        ...
        e.implement(this, h), this.setDocument = function (a) {
            ...
            if (f) return i(f);
            this.$mode || this.$setModePlaceholder(), k(function () {
                a([b], i)
            })
        ...
        this.$computeWrapSplits = function (a, b) {
            ...
            var c, d = 0,
                ...
                k = i[j],
                l = this.$docRowCache[j];
            if (0 < j && j < i.length) var g = i[j],
                d = this.$docRowCache[j],
                m = a > g || a == g && j == i.length - 1;
            else var m = !0;
            var n = this.getLength() - 1,
                o = this.getNextFoldLine(d),
                p = o ? o.start.row : Infinity;
            while (g <= a) {
                h = this.getRowLength(d);
                if (g + h - 1 >= a || d >= n) break;
                g += h, d++, d > p && (d = o.end.row + 1, o = this.getNextFoldLine(d, o), p = o ? o.start.row : Infinity), m && (this.$docRowCache.push(d), this.$screenRowCache.push(g))
            }
            if (o && o.start.row <= d) c = this.getFoldDisplayLine(o), d = o.start.row;
            else {
                if (g + h <= a || d > n) return {
                    row: n,
                    column: this.getLine(n).length
                };
                c = this.getLine(d), o = null
            }
            if (this.$useWrapMode) {
                var q = this.$wrapData[d];
                q && (f = q[a - g], a > g && q.length && (e = q[a - g - 1] || q[q.length - 1], c = c.substring(e)))
            }
            return e += this.$getStringScreenWidth(c, b)[1], this.$useWrapMode && e >= f && (e = f - 1), o ? o.idxToPosition(e) : {
                row: d,
                column: e
            }
    ...
    function e() {
        this.findMatchingBracket = function (a) {
            ...
            return null
        }, this.$findClosingBracket = function (a, b, c, e) {
            var f = this.$brackets[a],
                g = 1,
                h = new d(this, b.row, b.column),
                i = h.getCurrentToken();
            i || (i = h.stepForward());
            if (!i) return;
            c || (c = new RegExp("(\\.?" + i.type.replace(".", "\\.").replace("lparen", ".paren") + ")+"));
            var j = b.column - h.getCurrentTokenColumn();
            for (;;) {
                var k = i.value,
                    l = k.length;
                while (j < l) {
                    ...
                    if (m == f) {
                        ...
                        if (g == 0) return {
                            ...
                            column: j + h.getCurrentTokenColumn()
                        }
                    } else m == a && (g += 1);
                    j += 1
                }
                do {
                    i = h.stepForward();
                    if (e) if (i === null || i.type == "string") return {
                        row: h.getCurrentTokenRow() + (i === null ? 1 : -1),
                        column: 0
                    }
    ...
    (function () {
        this.set = function (a) {
            ...
            if (b.range) var c = b.range,
                e = a.getLines(c.start.row, c.end.row);
            else var e = a.doc.getAllLines();
            var g = [],
                h = b.re;
            if (b.$isMultiLine) {
                var i = h.length,
                ...
                for (var k = h.offset || 0; k < j; k++) {
                    for (var l = 0; l < h.length; l++) if (e[k + l].search(h[l]) == -1) break;
                    var m = e[k + l].match(h[0])[0].length,
                        n = line.match(h[i - 1])[0].length;
                    g.push(new f(k, startLine.length - m, k + i - 1, n))
                }
            } else for (var o = 0; o < e.length; o++) {
                var p = d.getMatchOffsets(e[o], h);
                for (var l = 0; l < p.length; l++) {
                    var q = p[l];
                    g.push(new f(o, q.offset, o, q.offset + q.length))
                }
            }
            if (b.range) {
                var r = c.start.column,
                    s = c.start.column,
                    o = 0,
                    l = g.length - 1;
                while (o < l && g[o].start.column < r && g[o].start.row == c.start.row) o++;
                while (o < l && g[l].end.column > s && g[l].end.row == c.end.row) l--;
                return g.slice(o, l + 1)
            }
            return g
        }, this.replace = function (a, b) {
            var c = this.$options,
            ...
            var c = b.range,
                ...
                c = b.range,
                f = b.start;
            f || (f = c ? c[d ? "end" : "start"] : a.selection.getRange()), f.start && (f = f[e != d ? "end" : "start"]);
            var g = c ? c.start.row : 0,
                h = c ? c.start.column : 0,
                i = c ? c.end.row : a.getLength() - 1;
            if (!d) var j = function (c) {
                var d = f.row,
                    e = a.getLine(d).substr(f.column);
                if (c(e, d, f.column)) return;
                for (d += 1; d <= i; d++) if (c(a.getLine(d), d)) return;
                if (b.wrap == 0) return;
                for (d = g, i = f.row; d <= i; d++) if (c(a.getLine(d), d)) return
            };
            else var j = function (c) {
                var d = f.row,
                    e = a.getLine(d).substring(0, f.column);
                if (c(e, d)) return;
                for (d--; d >= g; d--) if (c(a.getLine(d), d)) return;
                if (b.wrap == 0) return;
                for (d = i, g = f.row; d >= g; d--) if (c(a.getLine(d), d)) return
            };
            return {
                forEach: j
            }
    ...
    (function () {
        this.showGutter = !0, this.CHANGE_CURSOR = 1, this.CHANGE_MARKER = 2, this.CHANGE_GUTTER = 4, this.CHANGE_SCROLL = 8, this.CHANGE_LINES = 16, this.CHANGE_TEXT = 32, this.CHANGE_SIZE = 64, this.CHANGE_MARKER_BACK = 128, this.CHANGE_MARKER_FRONT = 256, this.CHANGE_FULL = 512, this.CHANGE_H_SCROLL = 1024, d.implement(this, p), this.setSession = function (a) {
            ...
            var b = this.CHANGE_SIZE,
                c = this.$size,
                d = e.getInnerHeight(this.container);
            ...
            if (this.$highlightGutterLine == a) return;
            this.$highlightGutterLine = a, this.$loop.schedule(this.CHANGE_GUTTER)
        }, this.getHighlightGutterLine = function () {
            return this.$highlightGutterLine
        }, this.$updateGutterLineHighlight = function (a) {
            var b = this.session.selection.lead.row;
            if (b == this.$gutterLineHighlight) return;
            if (!a) {
                var c = this.$gutterLayer.element.children,
                    d = c[this.$gutterLineHighlight - this.layerConfig.firstRow];
                d && e.removeCssClass(d, "ace_gutter_active_line");
                var f = c[b - this.layerConfig.firstRow];
                f && e.addCssClass(f, "ace_gutter_active_line")
            }
            this.$gutterLayer.removeGutterDecoration(this.$gutterLineHighlight, "ace_gutter_active_line"), this.$gutterLayer.addGutterDecoration(b, "ace_gutter_active_line"), this.$gutterLineHighlight = b
            ...
            if (a & this.CHANGE_H_SCROLL) {
                ...
                this.scrollLeft = b, this.session.setScrollLeft(b), this.scroller.className = this.scrollLeft == 0 ? "ace_scroller" : "ace_scroller horscroll"
            }
            ...
            n && (i = n.start.row), k = a.documentToScreenRow(i, 0), l = a.getRowHeight(m, i), j = Math.min(a.screenToDocumentRow(j, 0), a.getLength() - 1), c = this.$size.scrollerHeight + a.getRowHeight(m, j) + l, b = this.scrollTop - k * this.lineHeight, this.layerConfig = {
                width: d,
            ...
            var c = a.split("/").pop(),
                d = h.get("themePath") + "/theme-" + c + h.get("suffix");
            i.loadScript(d, b)
    ...
    (function () {
        e.implement(this, f), this.setSession = function (a) {
            ...
            for (;;) {
                ...
                if (e > f) break;
                var k = this.$annotations[e] || b;
                c.push("<div class='ace_gutter-cell", this.$decorations[e] || "", j[e] ? " ace_breakpoint " : " ", k.className, "' title='", k.text.join("\n"), "' style='height:", this.session.getRowLength(e) * a.lineHeight, "px;'>", e + 1);
                if (i) {
                    var l = i[e];
                    l == null && (l = i[e] = this.session.getFoldWidget(e)), l && c.push("<span class='ace_fold-widget ", l, l == "start" && e == h && e < g.end.row ? " closed" : " open", "'></span>")
                }
                c.push("</div>"), e++
            }
            this.session.$useWrapMode && c.push("<div class='ace_gutter-cell' style='pointer-events:none;opacity:0'>", this.session.getLength() - 1, "</div>"), this.element = d.setInnerHtml(this.element, c.join("")), this.element.style.height = a.minHeight + "px";
    ...
    (function () {
        this.$padding = 0, this.setPadding = function (a) {
            ...
            var f = e === "background" ? 0 : this.$padding,
                g = d.width + 2 * this.$padding - f,
                h = d.lineHeight,
                i = Math.round(g - b.start.column * d.characterWidth),
                j = this.$getTop(b.start.row, d),
                k = Math.round(f + b.start.column * d.characterWidth);
    ...
    (function () {
        d.implement(this, h), this.EOF_CHAR = "¶", this.EOL_CHAR = "¬", this.TAB_CHAR = "→", this.SPACE_CHAR = "·", this.$padding = 0, this.setPadding = function (a) {
            ...
            for (var k = d; k <= f; k++) {
                ...
                if (!l) continue;
                var m = [],
                    n = this.session.getTokens(k);
                this.$renderLine(m, k, n, !this.$useLineGroups()), l = e.setInnerHtml(l, m.join("")), k = this.session.getRowFoldEnd(k)
            }
            ...
            for (;;) {
                ...
                var i = e.createElement("div"),
                    j = [],
                    k = this.session.getTokens(f);
                this.$renderLine(j, f, k, !1), i.innerHTML = j.join("");
            ...
            for (;;) {
                ...
                var i = this.session.getTokens(f);
                this.$renderLine(b, f, i, !1), this.$useLineGroups() && b.push("</div>"), f++
            }
            this.element = e.setInnerHtml(this.element, b.join(""))
        }, this.$textToken = {
            text: !0,
            ...
            var e = this,
                f = /\t|&|<|( +)|([\u0000-\u0019\u00a0\u1680\u180E\u2000-\u200b\u2028\u2029\u202F\u205F\u3000\uFEFF])|[\u1100-\u115F\u11A3-\u11A7\u11FA-\u11FF\u2329-\u232A\u2E80-\u2E99\u2E9B-\u2EF3\u2F00-\u2FD5\u2FF0-\u2FFB\u3000-\u303E\u3041-\u3096\u3099-\u30FF\u3105-\u312D\u3131-\u318E\u3190-\u31BA\u31C0-\u31E3\u31F0-\u321E\u3220-\u3247\u3250-\u32FE\u3300-\u4DBF\u4E00-\uA48C\uA490-\uA4C6\uA960-\uA97C\uAC00-\uD7A3\uD7B0-\uD7C6\uD7CB-\uD7FB\uF900-\uFAFF\uFE10-\uFE19\uFE30-\uFE52\uFE54-\uFE66\uFE68-\uFE6B\uFF01-\uFF60\uFFE0-\uFFE6]/g,
            ...
            for (var k = 0; k < c.length; k++) {
                var l = c[k],
                    m = l.value;
                if (f + m.length < h) i = j.$renderToken(a, i, l, m), f += m.length;
                else {
            ...
            f.walk(function (a, b, d, e, f) {
                a ? g.push({
                    type: "fold",
                    value: a
                }) : (f && (c = this.session.getTokens(b)), c.length && h(c, e, d))
    ...
    function f(a) {
        var b = a.domEvent,
            ...
            h = a.getButton();
        if (!g && !c) {
            if (a.editor.inMultiSelectMode) if (h == 0) a.editor.exitMultiSelectMode();
            else if (h == 2) {
                var i = a.editor,
                    j = i.selection.isEmpty();
                i.textInput.onContextMenu({
                    x: a.clientX,
                    y: a.clientY
                }, j), d.capture(i.container, function () {}, i.textInput.onContextMenuClose), a.stop()
            }
            return
        }
        var i = a.editor,
            k = i.selection,
            l = i.inMultiSelectMode,
            m = a.getDocumentPosition(),
            n = k.getCursor(),
            o = a.inSelection() || k.isEmpty() && e(m, n),
            p = a.x,
            q = a.y,
            r = function (a) {
                p = a.clientX, q = a.clientY
            }, s = function () {
                var a = i.renderer.pixelToScreenCoordinates(p, q),
                    b = t.screenToDocumentPosition(a.row, a.column);
            ...
            u = i.renderer.pixelToScreenCoordinates(p, q),
            v = u;
        if (g && !f && !c && h == 0) {
            if (!l && o) return;
            if (!l) {
    ...
    var d = a("../lib/oop"),
        ...
        g = function (b, c, d, e) {
            ...
            if (f.get("packaged")) this.$worker = new Worker(f.get("workerPath") + "/" + c);
            else {
                var g;
                typeof a.supports != "undefined" && a.supports.indexOf("ucjs2-pinf-0") >= 0 ? g = a.nameToUrl("ace/worker/worker_sourcemint") : g = this.$normalizePath(a.nameToUrl("ace/worker/worker", null, "_")), this.$worker = new Worker(g);
                var h = {};
                for (var i = 0; i < b.length; i++) {
                    var j = b[i],
                        k = this.$normalizePath(a.nameToUrl(j, null, "_").replace(/.js$/, ""));
                    h[j] = k
                }
            }
...
}), define("ace/theme/textmate", ["require", "exports", "module", "text!ace/theme/textmate.css", "ace/lib/dom"], function (a, b, c) {
    b.isDark = !1, b.cssClass = "ace-tm", b.cssText = a("text!./textmate.css");
    var d = a("../lib/dom");
